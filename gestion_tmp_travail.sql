...
CREATE TABLE `demande` (
  ...
  `type` enum('Arrêt Maladie','Congés Payés','Heures Supplémentaire') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Congés Payés',
...
--
-- Déchargement des données de la table `maladie_spec`
--
